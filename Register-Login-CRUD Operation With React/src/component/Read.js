...
function Read() {
  ...
  return (
    <>
      ...
      <div>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <Button primary floated="left" onClick={() => navigate(-1)}>
          Back to Form
        </Button>
      </div>
      <br />
      <br />
      <br />
      <div style={{ backgroundColor: '#a39daa', minHeight: '100vh', paddingLeft: '20px' }}>
                ...
                >
                  ...
                  <Table.Cell>
                    <Button
                      inverted
                      color="blue"
                      onClick={() => navigateToLinkedIn(data.linkedinURL)}
                    >
                      LinkedIn
                    </Button>
                  </Table.Cell>
                  <Table.Cell>
                    <Button inverted color="red" onClick={() => deleteUser(data.id)}>
                      Delete
                    </Button>
                  </Table.Cell>
                  <Table.Cell>
                    <Button inverted color="green" onClick={() => updateUser(data)}>
                      Update
                    </Button>
                  </Table.Cell>
                </Table.Row>
